  ...
  >
    <div class="modal-content bg-dark">
      ...
      <div class="modal-body">
        ...
        <p>
          <strong>Domain:</strong> {{ props.domain.domain }}
          <br />
          <strong>Status:</strong>
          {{ props.domain.isBlocked ? "Blocked" : "Not Blocked" }}
        </p>
        <div
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-danger" @click="deleteDomain(props.domain._id)">
...
const deleteDomain = async (id) => {
  ...
  try {
    ...
    await axios
      .delete(`/v1/blocked-email-domains/${id}`)
      .then(() => {
        emit("delete", id);
      })
      .catch((err) => {
